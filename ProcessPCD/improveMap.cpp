...
int calcDensity(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud)
{
    int count = 0;
    float thick = -0.15 ;
    float len = 1;
...
int main()
{
    ...
    std::string fileName = "main_7_5_obj_L.pcd";
    std::string anlyzeName = "main_7_5_obj_L.txt";
    // dir
    std::string analyzed_dir = "/home/thuan12ha/_3Drobot_ws/ProcessPCD/output/analyzeData/";
    std::string dir = "/home/thuan12ha/_3Drobot_ws/ProcessPCD/output/";
    
    // input pcd
    std::string path = "/home/thuan12ha/_3Drobot_ws/ProcessPCD/_data_jetson/test_7_5/pcd/main_7_5_obj_L.pcd";
    // ouput pcd
    ...
    pass_filter.setFilterLimits(-0.2f, 5.0f);
    ...
    pass_filter.setFilterLimits(-2.0f, 1.8f);
